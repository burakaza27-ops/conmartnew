...
export const translations: Record<Locale, Record<string, string>> = {
  en: {
    ...
    seller_stat_listings: "Listings",
    seller_stat_orders: "Orders",
    seller_stat_enquiries: "Enquiries",
    seller_enquiries_badge: "enquiries",
    deals_nav: "Agent deals",
    deals_list_desc: "Free-tier suppliers are routed through a local agent. Open tickets stay here until an agent claims them.",
    deals_empty: "No agent-routed deals",
    deals_empty_desc: "These appear when a buyer contacts a free-tier supplier. Subscribed suppliers use Messages instead.",
    deals_open_chat: "Open agent chat",
    deals_view: "View ticket",
    agent_portal_back: "Agent portal",
    agent_browse_materials: "Browse materials",
    ...
    auth_agent_zone_label: "Coverage area",
    auth_agent_zone_placeholder: "Select your coverage area",
    auth_agent_zone_search: "Search city, sub-city, or depot area",
    auth_agent_zone_count: "{count} coverage areas across Ethiopia",
    auth_agent_zone_hint: "You will only see and claim free-supplier deals routed to this area. Pick the neighbourhood or city you actually work.",
    auth_agent_zone_empty: "Coverage areas could not be loaded. Refresh the page, or contact ConMart operations.",
  ...
  am: {
    ...
    seller_stat_listings: "ዝርዝሮች",
    seller_stat_orders: "ትዕዛዞች",
    seller_stat_enquiries: "ጥያቄዎች",
    seller_enquiries_badge: "ጥያቄዎች",
    deals_nav: "የወኪል ስምምነቶች",
    deals_list_desc: "ነጻ አቅራቢዎች በአካባቢ ወኪል ይመራሉ። ወኪሉ እስኪወስድ ድረስ ትኬቶች እዚህ ይቆያሉ።",
    deals_empty: "በወኪል የሚመራ ስምምነት የለም",
    deals_empty_desc: "ገዢ ነጻ አቅራቢን ሲያነጋግር እዚህ ይታያሉ። የደንበኛ አቅራቢዎች መልዕክቶችን ይጠቀማሉ።",
    deals_open_chat: "የወኪል ውይይት ክፈት",
    deals_view: "ትኬቱን ይመልከቱ",
    agent_portal_back: "የወኪል መግቢያ",
    agent_browse_materials: "ዕቃዎች ያስሱ",
    ...
    auth_agent_zone_label: "የአገልግሎት አካባቢ",
    auth_agent_zone_placeholder: "የሚሸፍኑት አካባቢ ይምረጡ",
    auth_agent_zone_search: "ከተማ፣ ክፍለ ከተማ ወይም ዴፖ ይፈልጉ",
    auth_agent_zone_count: "በኢትዮጵያ ውስጥ {count} የአገልግሎት አካባቢዎች",
    auth_agent_zone_hint: "በዚህ አካባቢ የሚመጡ ነጻ-አቅራቢ ስምምነቶችን ብቻ ያያሉ። የሚሠሩበትን ከተማ ወይም ሰፈር ይምረጡ።",
    auth_agent_zone_empty: "የአገልግሎት አካባቢዎች አልተጫኑም። ገጹን ያድሱ ወይም ኮንማርትን ያግኙ።",
